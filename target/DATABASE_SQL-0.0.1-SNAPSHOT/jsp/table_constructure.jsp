...
<body>
	...
	<br>
	<div style="margin-left: 30px; margin-right: 60px">
		<form action="http://localhost:8022/DATABASE_SQL/dTs/getTableMessageFromSql.do">
			从简单SQL中获取字段
			<input type="submit">
			<br> <br>
	...
	<br>
	<div style="margin-left: 30px; margin-right: 60px">
		<form action="http://localhost:8022/DATABASE_SQL/dTs/getTableMessageByTable.do">
			从表中获取字段
			<input type="submit">
			<br> 表名:<br>
			<input type="text" name="tableName" value="${table.tableName}">
			<br> 字段按行:<br>
			<textarea rows="10" cols="30" name="fieldsLine">${fieldsLine}</textarea>
		</form>
	</div>
	<div style="margin-left: 30px; margin-right: 60px">
		<form action="http://localhost:8022/DATABASE_SQL/dTs/getTableMessage.do">
			查看表全字段
			<input type="submit">
			表名:<br>
